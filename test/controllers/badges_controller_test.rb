...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { img_file: @badge.img_file, name: @badge.name, rule: @badge.rule } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { img_file: @badge.img_file, name: @badge.name, rule: @badge.rule } }
